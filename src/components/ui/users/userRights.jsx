...
export default function UserRights() {
  ...
  return (
    <div className="p-6 bg-secondary-color text-text-color">
      <h1 className="text-lg font-bold mb-4">Give Permission</h1>
      <div className="flex flex-col sm:flex-row sm:justify-start mb-4">
        <label htmlFor="package" className="text-lg font-medium sm:w-1/4 sm:text-left">
          Select Member Type:
        </label>
        <select
          id="package"
          ...
          className="mt-2 sm:mt-0 sm:w-3/4 p-2 border border-tertiary-color bg-white text-black"
        >
      ...
      {selectedPackage && (
        <div className="mt-6 border border-gray-300 rounded-lg p-4 overflow-x-auto">
          <h2 className="text-lg font-semibold mb-4">Rights for {selectedPackage}</h2>
              ...
              {item.children.length > 0 && (
                <div className="pl-4 mt-2">
                  {item.children.map((child, idx) => (
                    <div
                      key={idx}
                      className="flex flex-col sm:flex-row sm:gap-6 items-start sm:items-center gap-4 sm:gap-6 border border-gray-300 p-2 rounded-md mb-2"
                    >
