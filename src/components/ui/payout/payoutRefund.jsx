...
export default function PayoutRefund() {
  ...
  const handleSubmit = (e) => {
    ...
    // Validation Logic
    const { transactionID, memberInfo, remitterNumber, amount, apiTransID, operatorRef, status } = formData;
    if (!transactionID || !memberInfo || !remitterNumber || !amount || !apiTransID || !operatorRef || !status) {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-4">
          {[
            ...
            { label: "Remitter Number", name: "remitterNumber", disabled: true },
            ...
            <div key={idx} className="flex flex-col md:flex-row items-start md:items-center md:space-x-4 space-y-2 md:space-y-0">
