...
const mockData = [
  { MemberInfo: "John Doe", PayeeUPIAddress: "upi-1234567890", Amount: 100, Provider: "Airtel", APIID: "API123", TxnID: "T123", APITxnID: "API-T123", OperatorRef: "O123", APIMessage: "Success", Status: "Success", Source: "UPI", DateTime: "2024-12-30 12:34:56" },
  { MemberInfo: "Jane Smith", PayeeUPIAddress: "upi-0987654321", Amount: 50, Provider: "Jio", APIID: "API124", TxnID: "T124", APITxnID: "API-T124", OperatorRef: "O124", APIMessage: "Pending", Status: "Pending", Source: "UPI", DateTime: "2024-12-30 13:45:00" },
  { MemberInfo: "Mike Johnson", PayeeUPIAddress: "upi-4561237890", Amount: 75, Provider: "Vodafone", APIID: "API125", TxnID: "T125", APITxnID: "API-T125", OperatorRef: "O125", APIMessage: "Failed", Status: "Failed", Source: "UPI", DateTime: "2024-12-30 15:30:00" },
];
...
const UpiTransactions = () => {
  ...
  return (
    <div className="p-6 md:p-10 m-4 bg-gray-100">
      <h2 className="text-3xl font-bold text-cyan-600 mb-4">UPI Transactions</h2>

      {/* Filters Section */}
      <h3 className="text-xl font-bold text-black mb-4">⁜ UPI Transaction Filters</h3>
        ...
        <table className="table-auto w-full text-left">
          <thead>
            <tr className="bg-gray-200">
              ...
              <th className="p-3 text-sm sm:text-base">Payee UPI Address</th>
            ...
            {paginatedData.length > 0 ? (
              paginatedData.map((row, index) => (
                ...
                >
                  ...
                  <td className="p-3 text-sm sm:text-base">{row.PayeeUPIAddress}</td>
